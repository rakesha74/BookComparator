...
function process(key,value) {
	...
	fs.appendFile(path_new, data, function(error) {
		...
		console.log("Successfully wrote " + path_1);
		}
...
http.createServer(function (request_1, response_1) {
	var queryData = url.parse(request_1.url, true).query;
var query=queryData.product.replace("+","%20");
...
aa[0] = "GET\n" +
		...
		"-21&Keywords="+query+"&Operation=ItemSearch&ResponseGroup=Images%2CItemAttributes%2COffers&SearchIndex=Books&Service=AWSEComme" +
